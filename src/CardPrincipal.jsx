...
function CardPrincipal({ json: { id, // consumo a la API invocandolos como un json 
    symbol,
    current_price,
    image,
    ...
    return (   // uso del json para consultar la API y traer la image y los demas valores
        <>
